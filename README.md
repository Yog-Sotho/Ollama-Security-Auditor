...
[![Version](https://img.shields.io/badge/Version-1.4.0-green.svg)](https://github.com/YogSotho)
...
```bash
# Target IP or Host
python Ollama_Security_Auditor_v1.4.py http://192.168.1.100:11434
```

### Advanced Usage
```bash
# Deep scan with JSON output and custom delay
python Ollama_Security_Auditor_v1.4.py http://target:11434 \
  --output my_audit \
  --format json \
  --deep \
  --delay 0.5
...
**Yog-Sotho**  
🔗 [**Linktree**](https://linktr.ee/YogSotho) | 🛡️ Security Researcher | 🤖 AI & LLM Enthusiast
